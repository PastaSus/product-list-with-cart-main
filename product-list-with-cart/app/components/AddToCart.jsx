...
function AddToCart({ className, quantity, onAdd, onRemove, ariaLabel }) {
  return quantity === 0 ? (
    ...
    >
      <img alt="" src="/assets/images/icon-add-to-cart.svg" />
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="2" fill="none" viewBox="0 0 10 2" aria-hidden="true" focusable="false">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10" aria-hidden="true" focusable="false">
          <path fill="hsl(20, 50%, 98%)" d="M10 4.375H5.625V0h-1.25v4.375H0v1.25h4.375V10h1.25V5.625H10v-1.25Z" />
        </svg>
      </button>
    </div>
  );
