        ...
        <div>
                ...
                <div>
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10" aria-hidden="true" focusable="false">
                      <path fill="hsl(7, 20%, 60%)" d="M8.375 9.375 5 6 1.625 9.375l-1-1L4 5 .625 1.625l1-1L5 4 8.375.625l1 1L6 5l3.375 3.375-1 1Z" />
                    </svg>
                  </button>
                </div>
              </li>
          ...
          <div className="mt-6 pt-4">
            ...
            <div className="mt-6 flex items-center justify-center gap-2 rounded-lg bg-[var(--Rose-100)] px-5 py-4">
              <img alt="" src="/assets/images/icon-carbon-neutral.svg" />
